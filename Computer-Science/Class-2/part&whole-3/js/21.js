$(document).ready(function(){ 
	...
	function shuffleTiles(){
		if(shuffle == 1){
			...
			$('#piece-2').css({top: 0, left: 153});
			$('#piece-3').css({top: 153, left: 153});
			$('#piece-4').css({top: 153, left: 0});
		} else if(shuffle == 2){
			$('#piece-1').css({top: 0, left: 0});
			$('#piece-2').css({top: 0, left: 153});
			$('#piece-3').css({top: 153, left: 153});
		...
		if(tileClicked == false){  //  if no tile is clicked
			...
			setTimeout(function(){
				if(
					...
					$('#piece-2').css('left') == '153px' && $('#piece-2').css('top') == '0px' &&
					$('#piece-3').css('left') == '153px' && $('#piece-3').css('top') == '0px' &&
					$('#piece-4').css('left') == '0px' && $('#piece-4').css('top') == '153px'
				){

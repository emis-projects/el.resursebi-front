function game(){
    ...
    this.successPage  = () => {
		...
		if(el == true){
            let loc = location.pathname;
             if(loc == "/Computer-Science/Class-2/cycles-part-and-whole-5/5.html" || loc == "/el.resursebi-front/Computer-Science/Class-2/cycles-part-and-whole-5/5.html"){
                location.href = "game-success-5.html"

            } else if(loc == "/Computer-Science/Class-2/cycles-part-and-whole-5/6.html" || loc == "/el.resursebi-front/Computer-Science/Class-2/cycles-part-and-whole-5/6.html"){
    ...
    this.resetGame = () => {
        dragElement1MyArray.forEach(w => {
            ...
            $( "#differentGameDiv a").attr('href', "./5-1.html");

    ...
    document.querySelector('.completed__btn').addEventListener('click', function() {
        ...
        if (selected) {
            ...
            if (selected.getAttribute('data-answer') === 'correct') {
                ...
                document.querySelector('.col-5').childNodes[1].setAttribute('src', '../../../img/gakvetilebi/buneba/lesson4/N-1366-04-261.svg')
                ...
                btns.forEach(btn => {
                    if (btn.getAttribute('data-answer') === null) {
                        ...
                        btn.parentNode.parentNode.style.marginTop = '-100px'
                    }
                })

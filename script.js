...
function chooseColor(){
	...
	top.addEventListener('click', () => {
		...
		document.getElementById('blue-color-bottom').setAttribute('src', 'images/blue-color.svg');
		document.getElementById('red-color-bottom2').setAttribute('src', 'images/red-color.svg');
		...
		top.querySelectorAll('img').forEach(w => {
			...
			document.getElementById('yellow-color-top').setAttribute('src', 'images/blue-color-show.svg');
			document.getElementById('blue-color-top2').setAttribute('src', 'images/yellow-color-show.svg')
	...
	bottom.addEventListener('click', () => {
		...
		document.getElementById('yellow-color-top').setAttribute('src', 'images/blue-color.svg');
		document.getElementById('blue-color-top2').setAttribute('src', 'images/yellow-color.svg');
		...
		document.getElementById('blue-color-bottom').setAttribute('src', 'images/blue-color-show.svg')
		document.getElementById('red-color-bottom2').setAttribute('src', 'images/red-color-show.svg')
	});


	this.getExtraColor = () => {
		if(this.colors[0] === 'yellow' && this.colors[1] === 'blue'){
			img1.src = "images/yellow-color.svg";
			img2.src = "images/blue-color.svg";
			img1.setAttribute('data-color', 'mixin-yellow');
			img2.setAttribute('data-color', 'mixin-blue');
		}

		if(this.colors[0] === 'blue' && this.colors[1] === 'red'){
			img1.src = "images/red-color.svg";
			img2.src = "images/blue-color.svg";
	...
	this.getMixinColor = (img) => {		
		...
		if(this.mixinColor === "mixin-yellow" && this.mixinColorCount === 1){
			...
			img1.setAttribute('src', 'images/yellow-color-show.svg');
			img2.setAttribute('src', 'images/blue-color.svg');
			...
			img2.setAttribute('src', 'images/blue-color-show.svg');
			img1.setAttribute('src', 'images/yellow-color.svg')
			...
			img1.setAttribute('src', 'images/red-color-show.svg')
			img2.setAttribute('src', 'images/blue-color.svg');
			...
			img2.setAttribute('src', 'images/blue-color-show.svg');
			img1.setAttribute('src', 'images/red-color.svg')

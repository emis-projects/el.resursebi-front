...
function game() {
    ...
    let numberImages2 = document.querySelectorAll('.images--parent2 .DragGame—childs2');
    ...
    var dragElement4MyArray = [];
    for(var i = 0; i < numberImages2.length; i++ ){
        dragElement4MyArray.push(numberImages2[i])
    }
    ...
    this.init = () => {
        ...
        document.querySelector('.images--parent2').innerHTML = "";

        dragElement2MyArray.forEach(w => {
            document.querySelector('.images--parent').append(w)
        })

        dragElement4MyArray.forEach(w => {
            document.querySelector('.images--parent2').append(w)
        })

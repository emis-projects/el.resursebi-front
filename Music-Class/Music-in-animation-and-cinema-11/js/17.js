...
function game() {
    ...
    document.querySelector('.DragGame—childs1').querySelectorAll('.class_music_3-check_box_item').forEach(w => {
        w.addEventListener('click', (e) => {
            if(this.error1 || this.error2) {
                $('.DragGame—childs1 .class_music_3-check_box_item').removeClass('selected')
                $('.DragGame—childs1 .class_music_3-check_box_item').removeClass('error')
    ...
    document.querySelector('.DragGame—childs2').querySelectorAll('.class_music_3-check_box_item').forEach(w => {
        w.addEventListener('click', (e) => {
            if(this.error1 || this.error2) {
                $('.DragGame—childs2 .class_music_3-check_box_item').removeClass('selected')
                $('.DragGame—childs2 .class_music_3-check_box_item').removeClass('error')
    ...
    this.checkGameAnswers = () => {
        if(this.error1) {
            $('.DragGame—childs1 .class_music_3-check_box_item').removeClass('selected')
            $('.DragGame—childs1 .class_music_3-check_box_item').removeClass('success')
            $('.DragGame—childs1 .class_music_3-check_box_item').addClass('error')
        ...
        if(this.error2) {
            $('.DragGame—childs2 .class_music_3-check_box_item').removeClass('selected')
            $('.DragGame—childs2 .class_music_3-check_box_item').removeClass('success')
            $('.DragGame—childs2 .class_music_3-check_box_item').addClass('error')
    ...
    this.init = () => {
        ...
        $('.class_music_3-check_box_item').removeClass('correct--game');
